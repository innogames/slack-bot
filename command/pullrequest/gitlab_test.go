...
func spawnTestServer() *httptest.Server {
	...
	mux.HandleFunc("/api/v4/projects/12/merge_requests/13/approvals", func(res http.ResponseWriter, _ *http.Request) {
	...
	// returns an open PR
	mux.HandleFunc("/api/v4/projects/12/merge_requests/13", func(res http.ResponseWriter, _ *http.Request) {
	...
	// not existing PR
	mux.HandleFunc("/api/v4/projects/12/merge_requests/14", func(res http.ResponseWriter, _ *http.Request) {
